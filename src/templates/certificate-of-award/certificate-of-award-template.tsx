  ...
  return (
    <PageContainer>
      <Page>
        ...
        `}
        >
          <div className="certificate text-uppercase">{doc.name}</div>
          <div>is presented to</div>
          <div className="recipient text-uppercase">{doc.recipient.name}</div>
          <div>of</div>
          <div className="achievement-area text-uppercase">
            {doc.award.achievementArea}
            <br />
            in
            <br />
            {doc.award.instituteName}
          </div>
